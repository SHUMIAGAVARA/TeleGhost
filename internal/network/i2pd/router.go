...
#cgo linux LDFLAGS: -L${SRCDIR} -Wl,--whole-archive -li2pdclient -li2pd -li2pdlang -Wl,--no-whole-archive -Wl,-Bstatic -lboost_filesystem -lboost_program_options -lboost_date_time -lssl -lcrypto -lz -Wl,-Bdynamic -lpthread -lstdc++ -lm -latomic
#cgo windows LDFLAGS: -L${SRCDIR} -Wl,--whole-archive -li2pdclient -li2pd -li2pdlang -Wl,--no-whole-archive -lssl -lcrypto -lz -lboost_filesystem-mt -lboost_program_options-mt -lboost_date_time-mt -lpthread -lws2_32 -lmswsock -liphlpapi -lcrypt32 -lstdc++ -lm
