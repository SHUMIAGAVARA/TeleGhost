...
### 3. Этап «Real-Time & Modes»
- **Звонки**: Аудио-звонки через UDP (SSU2).
- **Профили защиты**: Переключение режимов туннелирования (🚀 **Fast**, 🛡️ **Default**, 👻 **Invisible**).

### 4. Этап «Экосистема»
- **Шлюзы**: Возможность отправки Email в обычный интернет.
- **Мобилизация**: Портирование ядра на Android (Gomobile).
- **Fidonet 2.0**: Создание сети транзитных узлов, которые невозможно заблокировать.
